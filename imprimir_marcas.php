...
$pdf->AddPage('P', 'LEGAL');
//celda para titulo
$pdf->Cell(0, 0, "REPORTE DE MARCAS", 0, 1, 'C');
//SALTO DE LINEA
$pdf->Ln();
...
$marcas= consultas::get_datos("select * from marca order by cod_mar");

foreach ($marcas as $marca) {
    $pdf->Cell(30, 5, $marca['cod_mar'], 1, 0, 'C', 1);
...
//SALIDA AL NAVEGADOR
$pdf->Output('reporte_marcas.pdf', 'I');
?>
