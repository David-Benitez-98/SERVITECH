...
<!--                                                    <a href="#" class="list-group-item">Cursos</a>                                                                          -->
        ...
        <script>
            function obtener_fecha() {
                $.ajax({
                    type: "POST",
                    url: "/servitech_tesis/inf_ventas_fecha.php/",
                    cache: false,
                    beforeSend: function () {
             ...
             function obtener_cliente() {
                $.ajax({
                    type: "POST",
                    url: "/servitech_tesis/inf_ventas_cliente.php/",
                    cache: false,
                    beforeSend: function () {
                        $('#cargando').html('<img src="/servitech_tesis/img/ajax-loader.gif">  <strong><i>Cargando...</i></strong>');
                    },
            ...
            function obtener_condicion() {
                $.ajax({
                    type: "POST",
                    url: "/servitech_tesis/inf_ventas_condicion.php/",
                    cache: false,
                    beforeSend: function () {
                        $('#cargando').html('<img src="/servitech_tesis/img/ajax-loader.gif">  <strong><i>Cargando...</i></strong>');
                    },
            ...
            function obtener_estado() {
                $.ajax({
                    type: "POST",
                    url: "/servitech_tesis/inf_ventas_estado.php/",
                    cache: false,
                    beforeSend: function () {
                        $('#cargando').html('<img src="/servitech_tesis/img/ajax-loader.gif">  <strong><i>Cargando...</i></strong>');
                    },
             ...
             function obtener_usuario() {
                $.ajax({
                    type: "POST",
                    url: "/servitech_tesis/inf_ventas_usuario.php/",
                    cache: false,
                    beforeSend: function () {
                        $('#cargando').html('<img src="/servitech_tesis/img/ajax-loader.gif">  <strong><i>Cargando...</i></strong>');
                    },
