...
$pdf->SetTitle('REPORTE DE DIAGNOSTICO EQUIPOS');
...
$pdf->AddPage('L', 'LEGAL');
//celda para titulo
$pdf->Cell(0, 0, "REPORTE DE DIAGNOSTICO DE EQUIPOS", 0, 1, 'C');
//SALTO DE LINEA
$pdf->Ln();
...
//            
         ...
         . "where cod_diagnostico=".$compra['cod_diagnostico']." order by cod_diagnostico");
            ...
            foreach ($detalles as $detalle) {
                ...
                $pdf->Cell(160, 5, $detalle['datos_equipos'], 1, 0, 'C', 1);
