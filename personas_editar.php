                    ...
                    <div class="col-lg-12">                                         
                        <div class="panel-body">
                            ...
                            <form action="personas_control.php" method="post" 
                               ...
                               <input type="hidden" name="pagina" value="personas_index.php">
                               ...
                               <?php } else { ?>
                                <div class="form-group" style="display: block" id="ocultarapellido">
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Apellido:</label>
                                        <div class="col-md-5">
                                            <input type="text"  id="apel2" autocomplete="off"
                                               onkeyup="reemplazar1();"
                                               onchange="reemplazar1();"
                                               onblur="sololetras3();"
                                               placeholder="Ingrese apellido" 
...
//                      var numero = trim(numero);
                ...
                if (numero2.length === 0 || numero2=== " " || numero2=== "  " || numero2=== "   " || numero2=== "    " || numero2=== "     " || numero2=== "      " || numero2=== "          " ){
                notificacion('Atencion','No se permiten campos vacios','error'); //y esta notificacion tiene mensaje rojo
               //  notificacion('Atencion','No se permiten campos vacios','mensaje'); //esta notificacion tiene mensaje amarillo
...
//                      var numero = trim(numero);
                ...
                if (numero3.length === 0 || numero3=== " " || numero3=== "  " || numero3=== "   " || numero3=== "    " || numero3=== "     " || numero3=== "      " || numero3=== "          " ){
                notificacion('Atencion','No se permiten campos vacios','error'); //y esta notificacion tiene mensaje rojo
               //  notificacion('Atencion','No se permiten campos vacios','mensaje'); //esta notificacion tiene mensaje amarillo
...
//                      var numero = trim(numero);
               ...
               if (numero4.length === 0 || numero4=== " " || numero4=== "  " || numero4=== "   " || numero4=== "    " || numero4=== "     " || numero4=== "      " || numero4=== "          " ){
                notificacion('Atencion','No se permiten campos vacios','error'); //y esta notificacion tiene mensaje rojo
               //  notificacion('Atencion','No se permiten campos vacios','mensaje'); //esta notificacion tiene mensaje amarillo
...
//function tipopersonaselec(){ //este anduvo kuri vai vai
//            
//            //si el radio button es juridico
//            var auxi = $("#check").val();
//            
