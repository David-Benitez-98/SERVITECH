    ...
    <div class="col-md-6 col-md-offset-0">
        <div class="list-group">
            <a href="#" class="list-group-item active">
                Informe de Nota de Debito Ventas
            </a>              
        </div>   
        <div class="form-group col-md-12">
            <label class="col-sm-5 control-label">Estado:</label>
            <div class="col-sm-6">
                <?php $compras = consultas::get_datos("select * from v_nota_debito_fac  order by nota_estado"); ?>                                                                 
...
<script>
    function enviar() {
        window.open("/servitech_tesis/imprimir_notadebito_ventas.php?vesta=" + $('#vesta').val() + 
                '&vop=' + $('#op').val(), '_blank');
    }
</script>
