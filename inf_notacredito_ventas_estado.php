...
<form accept-charset="utf8" class="form-horizontal">
    ...
    <div class="col-md-6 col-md-offset-0">
        ...
        <div class="form-group col-md-12">
            ...
            <div class="col-sm-6">
                <?php $compras = consultas::get_datos("select * from v_nota_cred_imprimir_fact  order by estado_nota"); ?>                                                                 
...
<script>
    function enviar() {
        window.open("/servitech_tesis/imprimir_notacredito_ventas.php?vesta=" + $('#vesta').val() + 
                '&vop=' + $('#op').val(), '_blank');
    }
</script>
