...
$pdf->Cell(0, 5, 'NOMBRE DE LOS GRUPOS', 1, 0, 'C', 1);
...
$grupos = consultas::get_datos("select * from grupos order by cod_gru");

foreach ($grupos as $grupo) {
    $pdf->Cell(30, 5, $grupo['cod_gru'], 1, 0, 'C', 1);
    $pdf->Cell(0, 5, $grupo['gru_nom'], 1, 0, 'L', 1);
    $pdf->Ln();//salto
}
