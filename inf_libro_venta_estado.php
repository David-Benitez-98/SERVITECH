    ...
    <div class="col-md-6 col-md-offset-0">
        <div class="list-group">
            <a href="#" class="list-group-item active">
                Informes de Libro Iva Venta
            </a>              
        </div>   
        <div class="form-group col-md-12">
            <label class="col-sm-5 control-label">Estado:</label>
            <div class="col-sm-6">
                <?php $ctas_pagar = consultas::get_datos("select * from libro_iva_venta  order by estado"); ?>                                                                 
...
<script>
    function enviar() {
        window.open("/servitech_tesis/imprimir_libro_iva_venta.php?vesta=" + $('#vesta').val() + 
                '&vop=' + $('#op').val(), '_blank');
    }
</script>
