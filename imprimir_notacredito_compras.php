...
$pdf->SetTitle('REPORTE DE NOTA DE CREDITO COMPRAS');
...
$pdf->AddPage('L', 'LEGAL');
//celda para titulo
$pdf->Cell(0, 0, "REPORTE DE NOTA DE CREDITO COMPRAS", 0, 1, 'C');
//SALTO DE LINEA
$pdf->Ln();
...
//consulta a la base de datos
    $compras = consultas::get_datos("select * from v_notacreditocompra "
                    . "where nota_cred_fecha between '" . $_REQUEST['vdesde'] . 
            "' and '" . $_REQUEST['vhasta'] . "' order by id_nota_credito");
...
//consulta a la base de datos
    $compras = consultas::get_datos("select * from v_notacreditocompra "
                    . "where cod_prov=" . $_REQUEST['vprov'] . " order by id_nota_credito");
...
//consulta a la base de datos
    $compras = consultas::get_datos("select * from v_notacreditocompra "
                    . "where cred_motiv='" . $_REQUEST['vcon'] . "' order by id_nota_credito");
...
//consulta a la base de datos
    $compras = consultas::get_datos("select * from v_notacreditocompra "
                    . "where nota_cred_estado='" . $_REQUEST['vesta'] . "' order by id_nota_credito");
...
//consulta a la base de datos
    $compras = consultas::get_datos("select * from v_notacreditocompra "
                    . "where cod_usu=" . $_REQUEST['vusu'] . " order by id_nota_credito");
