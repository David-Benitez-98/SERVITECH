...
$pdf->SetTitle('REPORTE DE PRESUPUESTO COMPRAS');
...
//consulta a la base de datos
    $compras = consultas::get_datos("select * from v_presupuesto_compra "
                    . "where fecha_presu between '" . $_REQUEST['vdesde'] . 
            "' and '" . $_REQUEST['vhasta'] . "' order by cod_presu_comp");
...
//consulta a la base de datos
    $compras = consultas::get_datos("select * from v_presupuesto_compra "
                    . "where cod_prov=" . $_REQUEST['vprov'] . " order by cod_presu_comp");
...
//consulta a la base de datos
    $compras = consultas::get_datos("select * from v_presupuesto_compra "
                    . "where com_condicion='" . $_REQUEST['vcon'] . "' order by cod_presu_comp");
...
//consulta a la base de datos
    $compras = consultas::get_datos("select * from v_presupuesto_compra "
                    . "where estado_presu='" . $_REQUEST['vesta'] . "' order by cod_presu_comp");
...
//consulta a la base de datos
    $compras = consultas::get_datos("select * from v_presupuesto_compra "
                    . "where cod_usu=" . $_REQUEST['vusu'] . " order by cod_presu_comp");
...
//consulta a la base de datos
    $compras = consultas::get_datos("select * from v_presupuesto_compra "
                    . "where estado_presu='" . $_REQUEST['vorden'] . "' order by cod_presu_comp");
