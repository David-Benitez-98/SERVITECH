    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h3 class="page-header">Listado de los Grupos
                            <a href="imprimir_grupos.php" 
                                        ...
                                        <table id="example1" width="100%" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody class="buscar">
                                                <?php foreach ($grupos as $grupo) { ?> 
                                                    <tr>
                                                        <td class="text-center"><?php echo $grupo['cod_gru']; ?></td>
                                                        <td class="text-center"><?php echo $grupo['gru_nom']; ?></td>
                                                        <td class="text-center">
                                                            <a onclick="editar(<?php echo "'" . $grupo['cod_gru'] . "_" .
                                                                    $grupo['gru_nom'] . "'"; ?>)" 
                                                               class="btn btn-xs btn-info" rel='tooltip' data-title="Editar" 
                                                               data-toggle="modal" data-target="#editar">
                                                                <span class="glyphicon glyphicon-pencil"></span></a>
                                                            <a onclick="borrar(<?php echo "'" . $grupo['cod_gru'] . "_" . 
                                                                    $grupo['gru_nom'] . "'"; ?>)" 
                        ...
                        <div class="modal-content">
                            ...
                            <form action="grupos_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                <div class="panel-body se">
                                    ...
                                    <input type="hidden" name="pagina" value="grupos_index.php">

                                    <label class="col-lg-2 control-label">Descripción:</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="vgru_nom" id="descri"
                                               required=""
                                               onkeyup="reemplazar()"
                                               onchange="reemplazar()"
                    ...
                    <div class="modal-content">
                        ...
                        <form action="grupos_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                            <div class="panel-body">
                                ...
                                <label class="col-lg-2 control-label">Descripción:</label>
                                <div class="col-lg-10">
                                    <input id="descri" type="text" class="form-control" name="vgru_nom" 
                                           required="" 
                                           pattern="[A-Za-z and 0-9 and #SPACE]{3,40}" title="Ingresa sólo letras. Tamaño mínimo: 3. Tamaño máximo: 40"
                                           autofocus="">
                                </div>
        ...
        <script>
            ...
            function borrar(datos) {
                var dat = datos.split("_");
                $('#si').attr('href', 'grupos_control.php?vgru_cod=' + dat[0] + '&vgru_nom=' + dat[1]
                        + '&accion=3&pagina=grupos_index.php');
                $('#confirmacion').html('<span class="glyphicon glyphicon-warning-sign"></span>\n\
            Desea Borrar el Grupo <i><strong>' + dat[1] + '</strong></i>?');
            }
            function reemplazar(){
//                   alert($('#apel').val());
