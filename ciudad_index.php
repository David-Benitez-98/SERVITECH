    ...
    <body>
                                        ...
                                        <table id="example1" width="100%" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody class="buscar">
                                                <?php foreach ($ciudades as $ciudad) { ?> 
                                                    <tr>
                                                        <td class="text-center"><?php echo $ciudad['cod_ciu']; ?></td>
                                                        <td class="text-center"><?php echo $ciudad['ciu_des']; ?></td>
                                                        <td class="text-center">
                                                            <a onclick="editar(<?php echo "'" . $ciudad['cod_ciu'] . "_" .
                                                                    $ciudad['ciu_des'] . "'"; ?>)" 
                                                               class="btn btn-xs btn-info" rel='tooltip' data-title="Editar" 
                                                               data-toggle="modal" data-target="#editar">
                                                                <span class="glyphicon glyphicon-pencil"></span></a>
                                                            <a onclick="borrar(<?php echo "'" . $ciudad['cod_ciu'] . "_" . 
                                                                    $ciudad['ciu_des'] . "'"; ?>)" 
        ...
        <script>
            ...
            function borrar(datos) {
                var dat = datos.split("_");
                $('#si').attr('href', 'ciudad_control.php?vciu_cod=' + dat[0] + '&vciu_nom=' + dat[1]
