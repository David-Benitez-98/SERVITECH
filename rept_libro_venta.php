          ...
          <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h3 class="page-header">Informe de Libro Iva Venta</h3>
                    </div>     
                                        ...
                                        <div class="row">                                        
                                            <div class="col-md-4 col-md-offset-0">
                                                <div class="list-group">
                                                    ...
                                                    <a  href="#" onclick="obtener_fecha()" 
                                                        class="list-group-item">Por Fecha</a>
                                                    <a href="#" onclick="obtener_estado()" 
                                                       class="list-group-item">Por Estado</a>
                                                       <a href="#" onclick="obtener_proveedor()" 
                                                       class="list-group-item">Por Cliente</a>
<!--                                                    <a href="#" class="list-group-item">Cursos</a>                                                                          -->
        ...
        <script>
            function obtener_fecha() {
                $.ajax({
                    type: "POST",
                    url: "/servitech_tesis/inf_libro_venta_fecha.php/",
                    cache: false,
                    beforeSend: function () {
             ...
             function obtener_estado() {
                $.ajax({
                    type: "POST",
                    url: "/servitech_tesis/inf_libro_venta_estado.php/",
                    cache: false,
                    beforeSend: function () {
                        $('#cargando').html('<img src="/servitech_tesis/img/ajax-loader.gif">  <strong><i>Cargando...</i></strong>');
                    },
            ...
            function obtener_proveedor() {
                $.ajax({
                    type: "POST",
                    url: "/servitech_tesis/inf_libro_iva_venta_cli.php/",
                    cache: false,
                    beforeSend: function () {
                        $('#cargando').html('<img src="/servitech_tesis/img/ajax-loader.gif">  <strong><i>Cargando...</i></strong>');
                    },
