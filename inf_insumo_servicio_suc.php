    ...
    <div class="col-md-6 col-md-offset-0">
        <div class="list-group">
            <a href="#" class="list-group-item active">
                Informes de Diagnostico de Equipos 
            </a>              
        </div>   
            ...
            <div class="col-sm-6">
                ...
                <select name="vpag" class="form-control select2" id="vprov">
                    ...
                    if (!empty($proveedores)) {
                        ...
                        ?>
                        <option value="0">Debe insertar un sucursal</option>
                    <?php } ?> 
                </select>
            </div>
...
<script>
    function enviar() {
        window.open("/servitech_tesis/imprimir_insumos_servicios.php?vprov=" + $('#vprov').val() + 
                '&vop=' + $('#op').val(), '_blank');
    }
</script>
