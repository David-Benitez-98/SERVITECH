...
<form accept-charset="utf8" class="form-horizontal">
    ...
    <div class="col-md-6 col-md-offset-0">
        ...
        <div class="form-group col-md-12">
            ...
            <div class="col-sm-6">
                <?php $compras = consultas::get_datos("select * from v_insumos_utilizados  order by estado"); ?>                                                                 
...
<script>
    function enviar() {
        window.open("/servitech_tesis/imprimir_insumos_servicios.php?vesta=" + $('#vesta').val() + 
                '&vop=' + $('#op').val(), '_blank');
    }
</script>
