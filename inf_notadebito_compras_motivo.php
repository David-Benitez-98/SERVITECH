    ...
    <div class="col-md-6 col-md-offset-0">
        <div class="list-group">
            <a href="#" class="list-group-item active">
                Informe de Nota de Debito Compra
            </a>              
        </div>   
        <div class="form-group col-md-12">
            <label class="col-sm-5 control-label">Motivo:</label>
            <div class="col-sm-6">
                <?php $compras = consultas::get_datos("select * from v_notadebito_compra order by debi_motivo"); ?>                                                                 
...
<script>
    function enviar() {
        window.open("/servitech_tesis/imprimir_notadebito_compras.php?vcon=" + $('#vcon').val() + 
                '&vop=' + $('#op').val(), '_blank');
    }
</script>
