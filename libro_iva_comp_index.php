...
<html>
    <head>
        ...
        <title>SYSMAD - LIBRO IVA COMPRA</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h2 class="page-header text-center">Listado del Libro IVA 
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-success">
                            ...
                            <?php
                            $libros_compras = consultas::get_datos("select * from libro_iva_comp 
                                         order by cod_libro_iva_comp asc ");
...
<!--                                                    <th class="text-center">Acciones</th>-->
                                            ...
                                            <tbody class="buscar">
                                                <?php foreach ($libros_compras as $libro_compra) { ?> 
                                                    <tr>
                                                        <td class="text-center"><?php echo $libro_compra['cod_libro_iva_comp']; ?></td>
                                                        <td class="text-center"><?php echo $libro_compra['cod_comp']; ?></td>
                                                        ...
                                                        <td class="text-center"><?php echo $libro_compra['estado_libro']; ?></td>
