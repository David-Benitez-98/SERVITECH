...
//consulta a la base de datos
    $compras = consultas::get_datos("select * from v_orden_compra3 "
                    . "where fecha_orden between '" . $_REQUEST['vdesde'] . 
            "' and '" . $_REQUEST['vhasta'] . "' order by id_orden_compra");
...
//consulta a la base de datos
    $compras = consultas::get_datos("select * from v_orden_compra3 "
                    . "where cod_prov=" . $_REQUEST['vprov'] . " order by id_orden_compra");
...
//consulta a la base de datos
    $compras = consultas::get_datos("select * from v_orden_compra3 "
                    . "where estado_orden_compra='" . $_REQUEST['vesta'] . "' order by id_orden_compra");
...
//consulta a la base de datos
    $compras = consultas::get_datos("select * from v_orden_compra3 "
                    . "where cod_usu=" . $_REQUEST['vusu'] . " order by id_orden_compra");
...
//consulta a la base de datos
    $compras = consultas::get_datos("select * from v_orden_compra3 "
                    . "where estado_orden_compra='" . $_REQUEST['vorden'] . "' order by id_orden_compra");
