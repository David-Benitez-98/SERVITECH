...
<form accept-charset="utf8" class="form-horizontal">
    ...
    <div class="col-md-6 col-md-offset-0">
        ...
        <div class="form-group col-md-12">
            ...
            <div class="col-sm-6">
                <?php $compras = consultas::get_datos("select * from v_nota_remision_compra  order by estado"); ?>                                                                 
                <select name="vpag" class="form-control select2" id="vesta">

                 <option value="ACTIVO">ACTIVO</option>
                 <option value="CONFIRMADO RECIBIDO">CONFIRMADO</option>
...
<script>
    function enviar() {
        window.open("/servitech_tesis/imprimir_notaremision_compras.php?vesta=" + $('#vesta').val() + 
                '&vop=' + $('#op').val(), '_blank');
    }
</script>
