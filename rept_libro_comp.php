          ...
          <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h3 class="page-header">Informe de Libro Iva Compra</h3>
                    </div>     
...
<!--                                                    <a href="#" class="list-group-item">Cursos</a>                                                                          -->
        ...
        <script>
            function obtener_fecha() {
                $.ajax({
                    type: "POST",
                    url: "/servitech_tesis/inf_libro_comp_fecha.php/",
                    cache: false,
                    beforeSend: function () {
             ...
             function obtener_estado() {
                $.ajax({
                    type: "POST",
                    url: "/servitech_tesis/inf_libro_comp_estado.php/",
                    cache: false,
                    beforeSend: function () {
                        $('#cargando').html('<img src="/servitech_tesis/img/ajax-loader.gif">  <strong><i>Cargando...</i></strong>');
                    },
            ...
            function obtener_proveedor() {
                $.ajax({
                    type: "POST",
                    url: "/servitech_tesis/inf_libro_iva_comp_prov.php/",
                    cache: false,
                    beforeSend: function () {
                        $('#cargando').html('<img src="/servitech_tesis/img/ajax-loader.gif">  <strong><i>Cargando...</i></strong>');
                    },
